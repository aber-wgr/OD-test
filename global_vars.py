...
dataset_reference_waes = {
    ...
    'CIFAR10':            [ModelFactory(AES.Generic_WAE, dims=(3, 32, 32), levels=3, filter='db3', depth=10, n_hidden=256)],
    'CIFAR100':           [ModelFactory(AES.Generic_WAE, dims=(3, 32, 32), levels=3, filter='db3', depth=10, n_hidden=256)],
    'STL10':              [ModelFactory(AES.Generic_WAE, dims=(3, 96, 96), levels=4, filter='db3', depth=10, n_hidden=512)],
    'TinyImagenet':       [ModelFactory(AES.Generic_WAE, dims=(3, 64, 64), levels=4, filter='db3', depth=10, n_hidden=512)],
}
