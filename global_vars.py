...
dataset_reference_waes = {
    'MNIST':              [ModelFactory(AES.Generic_WAE, dims=(1, 28, 28), levels=2, filter='bior2.8', n_hidden=96)],
    'FashionMNIST':       [ModelFactory(AES.Generic_WAE, dims=(1, 28, 28), levels=2, filter='bior2.8', n_hidden=96)],
    'CIFAR10':            [ModelFactory(AES.Generic_WAE, dims=(3, 32, 32), levels=3, filter='bior2.8', n_hidden=256)],
    'CIFAR100':           [ModelFactory(AES.Generic_WAE, dims=(3, 32, 32), levels=3, filter='bior2.8', n_hidden=256)],
    'STL10':              [ModelFactory(AES.Generic_WAE, dims=(3, 96, 96), levels=4, filter='bior2.8', n_hidden=512)],
    'TinyImagenet':       [ModelFactory(AES.Generic_WAE, dims=(3, 64, 64), levels=4, filter='bior2.8', n_hidden=512)],
}
